...
class LightThemeColors {
  ...
  static Color selectedItem = Color(0xffabaaaa);
  static Color greenApp = Color(0xff0cd638);
...
ThemeData lightTheme = ThemeData(
  ...
  dividerColor: LightThemeColors.secondaryTextColor,
...
ThemeData darkTheme = ThemeData(
  ...
  cardColor: const Color(0xaa929393),
  dividerColor: DarkThemeColors.secondaryTextColor,
  focusColor: const Color(0x1aF5E0C3),
  hoverColor: const Color(0xffe6e6fa),
  highlightColor: const Color(0xffb2b2b0),
  splashColor: const Color(0xffb9cace),
